...
public class PropertiesPanelViewModel : ViewModelBase
{
    ...
    public PropertyPanelType CurrentPanel
    {
        ...
        private set
        {
            ...
            // Fire INPC for all the derived bool properties the View binds to.
            OnPropertyChanged(nameof(ShowProjectProperties));
            OnPropertyChanged(nameof(ShowTagGroupEditor));
            OnPropertyChanged(nameof(ShowTagEditor));
...
public enum PropertyPanelType { None, Project, TagGroup, Tag }